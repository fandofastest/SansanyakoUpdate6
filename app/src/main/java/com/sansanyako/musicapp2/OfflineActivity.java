...
import com.sansanyako.musicapp2.adapter.TrackAdapterOffline;
import com.sansanyako.musicapp2.model.TrackOffline;
...
import static com.sansanyako.musicapp2.SplashActivity.PERCODE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                search_query = query;
                Intent i = new Intent(OfflineActivity.this, OnlineActivity.class);
