package com.sansanyako.musicapp2;
...
import com.sansanyako.musicapp2.adapter.TrackAdapter;
import com.sansanyako.musicapp2.model.TrackOnline;
...
public class OnlineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SplashActivity.ads_sett.equals("fb")) {
            fbView = new com.facebook.ads.AdView(this,SplashActivity.id_banner, AdSize.BANNER_HEIGHT_50);
            banner.addView(fbView);
            fbView.loadAd();
        } else {
            adView = new com.google.android.gms.ads.AdView(this);
            adView.setAdUnitId(SplashActivity.id_banner);
    ...
    private class LoadSearchData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            listOnline.clear();
            mProgressDialog = new ProgressDialog(OnlineActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                url = new URL(api + "/tracks.json?client_id=" + SplashActivity.sc + "&q=" + search_query.replaceAll(" ","+") + "&limit=100");
...
//                        Toast.makeText(getApplicationContext(),song_url,Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_offline) {
            Intent i = new Intent(OnlineActivity.this,OfflineActivity.class);
            startActivity(i);
            return true;
        }
